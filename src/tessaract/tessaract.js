!(function(e, t) {
	'object' == typeof exports && 'object' == typeof module
		...
		: 'function' == typeof define && define.amd
			? define([], t)
			: 'object' == typeof exports ? (exports.Tesseract = t()) : (e.Tesseract = t());
})(window, function() {
	return (function(e) {
		var t = {};
		function r(n) {
			...
			e.exports = function() {
				...
				var P = function(e, t) {
					...
					R = function() {
						...
						return S(l({ id: t, action: 'loadLanguage', payload: { langs: e, options: c } }));
					},
					T = function() {
						var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 'eng',
							t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : h,
							r = arguments.length > 2 ? arguments[2] : void 0;
						return S(l({ id: r, action: 'initialize', payload: { langs: e, oem: t } }));
					},
					_ = function() {
						var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
							t = arguments.length > 1 ? arguments[1] : void 0;
						return S(l({ id: t, action: 'setParameters', payload: { params: e } }));
					},
					A = (function() {
						var e = o(
					...
					D = function() {
						var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 'Tesseract OCR Result',
							...
							r = arguments.length > 2 ? arguments[2] : void 0;
						return S(l({ id: r, action: 'getPDF', payload: { title: e, textonly: t } }));
					},
					N = (function() {
						var e = o(
							regeneratorRuntime.mark(function e(t, r) {
								return regeneratorRuntime.wrap(function(e) {
									for (;;)
										switch ((e.prev = e.next)) {
											case 0:
												return (e.t0 = S), (e.t1 = l), (e.t2 = r), (e.next = 5), w(t);
											case 5:
												return (
													(e.t3 = e.sent),
													(e.t4 = { image: e.t3 }),
				...
				return (
					m(k, function(e) {
						...
						if ('resolve' === o) {
							...
							'recognize' === c
								? (s = f(u))
								: 'getPDF' === c && (s = Array.from(a({}, u, { length: Object.keys(u).length }))),
								y[c]({ jobId: r, data: s });
						} else if ('reject' === o) {
